...
export const AuthorizedUser = ({id, title, completed, onEdit, onDelete}) => {
        ...
        <div>
            {isEdit ? (
                <form onSubmit={handleOnEditSubmit}>
                    ...
                    <input placeholder="Completed" name="completed" defaultValue={completed}
                           id={"EditTaskCompletedInput"}/>
